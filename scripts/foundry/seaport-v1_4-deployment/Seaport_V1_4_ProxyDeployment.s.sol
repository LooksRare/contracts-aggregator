    ...
    function run() external {
        ...
        address seaportProxyAddress = IMMUTABLE_CREATE2_FACTORY.safeCreate2({
            ...
            initializationCode: abi.encodePacked(
                ...
                abi.encode(0x00000000000001ad428e4906aE43D8F9852d0dD6, address(looksRareAggregator))
            )
        });

        LooksRareAggregator looksRareAggregator = LooksRareAggregator(
            payable(0x00000000005228B791a99a61f36A130d50600106)
        );
