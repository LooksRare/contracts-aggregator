...
/**
 * @notice SeaportProxy ERC721 WETH orders tests (Seaport 1.4)
 */
contract Seaport_V1_4_ProxyERC721WETHTest is TestParameters, TestHelpers, Seaport_V1_4_ProxyTestHelpers {
    ...
    function _testExecute(bool isAtomic) private {
        ...
        IERC20(WETH_GOERLI).approve(address(erc20EnabledAggregator), totalPrice);
